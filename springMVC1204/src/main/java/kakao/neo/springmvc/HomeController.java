...
import kakao.neo.springmvc.domain.User;

//bean을 자동생성해주는 어노테이션
//의미상 이 클래스의 객체는 Controller의 역할을 한다는 것을 알려
@Controller
public class HomeController {
	...
	//String을 리턴하면 리턴하는 문자열이 뷰의 이름이 됨
	//ViewResolver 와 WEB-INF/views/home.jsp가 출력하는 뷰의 이름이 됨
	...
	public String detail(@PathVariable int no,Model model) {
			//no 라는 key에 no 데이터를 저장
		model.addAttribute("no",no);
		return "detail";
	}
	//login 요청이 POST 로 왔을 때 처리하는 메소드
