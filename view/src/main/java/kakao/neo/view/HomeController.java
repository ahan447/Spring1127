...
import kakao.neo.view.service.ViewService;
...
public class HomeController {
	...
	*/
	...
	//filename이라는 파라미터를 filename 이라는 변수에 저장
	public String download(Model model,
			@RequestParam("filename") String filename) {
		//다운로드 받을 파일 객체를 생성
		File file = new File("/Users/tjoeun304/Downloads/" + filename);
