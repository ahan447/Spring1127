...
public class LogInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(
		...
		//java 1.7부터 사용 가능한 문법으로 close를 할 필요가 없어짐
		try(FileOutputStream fos = new FileOutputStream("/Users/tjoeun304/Documents/" + filename, true);
			PrintWriter pw = new PrintWriter(fos);) {
		//현재 날짜 및 시간을 갖는 객체 생성
		java.util.Date date = new java.util.Date();
		//파일에 기록
		pw.print(request.getRequestURI() + " " + date.toString());
		pw.flush();
